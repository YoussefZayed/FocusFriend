        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "what they are looking at, their posture, and the specific content/applications on the screen(s). If they are looking infront of them then assume they are looking at the screen. "
                    ...
                    "The user is 'focused' ONLY IF they are looking directly at the screen AND the screen displays content relevant to work or study (e.g., code editor, document, educational website). "
                    "Otherwise, they are 'distracted' (e.g., looking away, phone use, social media, games, unrelated websites). "
